...
"""Tests for sub-module et_md2.interactions.lj."""

import sys
sys.path.insert(0,'.')

import et_md2.interactions.lj
LJ = et_md2.interactions.lj.LJ_py
...
def test_scaling():
    lj0 = LJ()
    lj1 = LJ(epsilon=1)
    epot0 = lj0.interaction_energy(1.)
    epot1 = lj1.interaction_energy(1.)
    ...
    lj2 = LJ(sigma=sigma)
    rij = 1.2
    epot0 = lj0.interaction_energy(rij**2)
    epot1 = lj2.interaction_energy((rij*sigma)**2)
    # print(epot1,epot0)
    assert epot1 == epot0
